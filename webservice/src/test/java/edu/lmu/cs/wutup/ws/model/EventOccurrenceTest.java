...
public class EventOccurrenceTest {
    ...
    public void toStringProducesExpectedString() {
        ...
        String expected1 = "EventOccurrence{id=3, event=Event{id=1, name=Party, description=A hoedown!, " +
        		"creator=User{id=1, email=dondi@example.com, firstname=null, lastname=null, nickname=null}}, " +
        		"location=Venue{id=3, address=, latitude=33.969369, longitude=-118.414386, propertyMap=null}, " +
        ...
        String expected2 = "EventOccurrence{id=5, event=Event{id=1, name=Party, description=A hoedown!, " +
        		"creator=User{id=1, email=dondi@example.com, firstname=null, lastname=null, nickname=null}}, " +
        		"location=null, start=2012-09-27T09:25:00.000-07:00, end=2012-09-27T10:40:00.000-07:00}";
